...
import botsayhi from "@/assets/lottiefiles/botsayhi.json";
...
export default function OnboardingPage() {
  ...
  const stepDescription = useMemo(() => {
    ...
    if (step === 2) return "Bắt đầu với chủ đề bạn muốn cải thiện nhất.";
      ...
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-8 sm:mb-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm sm:text-base text-slate-600 dark:text-slate-400">
            Tailor your learning experience by selecting your grade, topic, and
            mode.
          </p>
        </div>
        ...
        <div className="rounded-[24px] sm:rounded-[32px] border border-slate-200 bg-white p-5 sm:p-8 shadow-xl dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="mb-8 sm:mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="
                absolute top-55 right-2
                sm:top-60 sm:right-2
                md:top-70 md:right-20
                w-[90px] sm:w-[90px] md:w-[150px]
                opacity-80 pointer-events-none
                ">
                <Lottie animationData={botsayhi} loop={true} />
            </div>
          </div>
